...
#define USERDATA_NAME "__userdata"
#define USERDATA_TYPE "__userdata_type"

namespace StairsGame {

BaseUserData::BaseUserData(const char* userdata_type, const char* metatable_name){
    table_ref = LUA_REFNIL;
    obj = NULL;
    this->userdata_type = userdata_type;
    this->metatable_name = metatable_name;
}
